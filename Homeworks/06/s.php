...
//            $username_err = "Please enter a name to search.";
//        } else {
...
//                echo "<tr><td>" . $row["id"] . "</td><td>" . $row["name"] . "</td><td>" . $row["gender"] . "</td><td>" . $row["dob"] . "</td><td>" . $row["genre"];
//            }
//            echo "</table></div>";
//        } else {
//            echo "0 results";
...
<!---->
<?php
//$conn = mysqli_connect("localhost", "root", "uber", "Web Programming");
//// Check connection
//if ($conn->connect_error) {
//    die("Connection failed: " . $conn->connect_error);
//}
